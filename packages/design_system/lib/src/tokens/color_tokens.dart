  ...
  Color operator [](int shade) {
    switch (shade) {
      ...
      case 900:
        return shade900;
      default:
        throw ArgumentError('Invalid shade: $shade');
    }
  }
...
/// Backwards-compatible facade for legacy code that referenced `ColorTokens`.
/// Provides a small set of commonly used static colors mapped to the
/// current `UiTokens` defaults.
class ColorTokens {
  static final UiColorTokens _t = UiTokens.standard().colorTokens;

  static Color get surface => _t.neutral.shade50;
  static Color get outline => _t.neutral.shade300;
  static Color get primary => _t.primary.shade500;
  static Color get error => _t.error[500]!;
  static Color get info => _t.info[500]!;
  static Color get success => _t.success[500]!;
  static Color get warning => _t.warning[500]!;
}
