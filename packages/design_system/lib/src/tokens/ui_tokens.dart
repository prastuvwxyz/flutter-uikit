...
// Re-export the compatibility facades so legacy names (SpacingTokens, RadiusTokens,
// ElevationTokens, TypographyTokens) are available to files that import ui_tokens.
export 'compat_tokens.dart';
...
class UiTokens extends ThemeExtension<UiTokens> {
  ...
  static UiTokens of(BuildContext context) {
    return Theme.of(context).extension<UiTokens>() ?? UiTokens.standard();
  }
